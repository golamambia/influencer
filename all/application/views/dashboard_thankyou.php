                  ...
                  <div class="row row-0">
                     <div class="col-lg-6  d-flex  align-content-stretch">
                       ...
                       <div class="">
                          ...
                          <div class="price">$<?=$pack_info[0]->amount;?></div>
                          <h3>thank you<br> Subscription successful</h3>
                         </div>
                       </div>
                     </div>
                      <div class="col-lg-6 d-flex  align-content-stretch">
                            ...
                            <table class="table table-bordered">
                             <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><?=$pack_info[0]->ptitle;?></td>
                                </tr>
                                <tr>
                                  <th scope="row">Searches</th>
                                  <td><?=$pack_info[0]->psearch;?></td>
                                </tr>
                                <tr>
                                  <th scope="row">Export</th>
                                  <td><?=$pack_info[0]->pexport;?></td>
                                </tr>

                                <tr>
                                  <th scope="row">Export profile</th>
                                  <td><?=$pack_info[0]->pdataid;?></td>
                                </tr>


                                <tr>
                                  <th scope="row">Txn Id</th>
                                  <td><div class="emaibox"><?=$this->input->get('tid',true);?></div></td>
                                </tr>
