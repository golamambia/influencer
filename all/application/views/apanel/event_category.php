              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  method="post" action="<?php echo base_url();?>apanel/event/category_post" class="contact-input">
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
             ...
             aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>apanel/event/category_edit/<?=$value->id;?>">
                      <div class="modal-header">
