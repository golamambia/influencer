...
public function create()
    {
        ...
        $this->load->view('apanel/influence_price');
...
public function create_post()
    {
        ...
        if ($this->form_validation->run() == FALSE) 
        {
           ...
           redirect('apanel/pricing/'); 
            
        }else{
            $_POST['entry_date']=date('Y-m-d');
        $query= $this->General_model->show_data_id('pricing_table','','','insert',$this->input->post());
    ...
    public function pricing_edit($id)
    {
        ...
        $query= $this->General_model->show_data_id('pricing_table',$id,'pid','update',$this->input->post());
    ...
    redirect('apanel/pricing/'); 
     ...
     { 
        $query=$this->General_model->show_data_id('pricing_table',$id,'pid','delete','');
