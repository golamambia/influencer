...
?>			
    ...
    color: #e7700a;"><?=$this->session->userdata('dataid_msg');?></p>
            ...
            <div class="media <?php if($this->session->userdata('infl_sess')['userid']){echo"";}else{echo"hide-result";}?>">
                              ...
                              <a href="javascript:void(0)" class="add_to_cart cardclick">   <img class="mr-2" src="<?=$value->profile_picture_url;?>" alt="<?=$value->user_name;?>" title="<?=$value->user_name;?>" />
                     </a>
...
<!---------popup html start----->
    ...
    <div class="aside">
        <div class="aside-header">
                   ...
                   <div class="row row-0">
                      ...
                      <div class="col-lg-7 col-md-7  d-flex align-content-stretch">
                        <div class="aside_contantbox d-block w-100">
                          <ul>
                             <li><strong>sonjo@bose</strong></li>
                             <li>first name</li>
                             <li>last name</li>
                             <li>sonjo@125gmail.com</li>
                          </ul>
                        </div>
                      </div>
                   </div>
            ...
            <span class="close" data-dismiss="aside" aria-hidden="true"><i class="zmdi zmdi-chevron-right"></i></span>
        </div>
        ...
        <div class="instagram_likebox d-flex justify-content-between">
          ...
          <div class="likebox ">
            <div class="d-block text-center">
              ...
              <span>6.0k<i class="fa fa-heart-o" aria-hidden="true"></i></span>
              <p>avg. like</p>
            </div>
          </div>
           <div class="likebox ">
            <div class="d-block text-center">
              <span>233<i class="fa fa-comment-o" aria-hidden="true"></i></span>
              <p>avg. comments</p>
            </div>
          </div>
        ...
        <div class="aside-contents">
           <div class="owl-carousel instagram-carousel" id="instagramcarousel">
              ...
              <div class="d-block w-100">
                ...
                <div class="instagram_bootom">
                  <div class="instagram_bootom_top clearfix">
                    <ul>
                      <li>6.0k<i class="fa fa-heart-o" aria-hidden="true"></i></li>
                      <li>233<i class="fa fa-comment-o" aria-hidden="true"></i></li>
                      <li>1 days ago</li>
                    </ul>
                  </div>
                  <p>𝒲𝑒𝓁𝒸🌺𝓂𝑒❣ 𝒯𝒽𝒾𝓈 𝓈𝒾𝓉𝑒 𝒶𝓁𝓁🌞𝓌𝓈 𝓎🍪𝓊 𝓉☯ 𝑔𝑒𝓃𝑒𝓇𝒶𝓉𝑒 𝓉𝑒𝓍𝓉 𝒻🌞𝓃𝓉𝓈 𝓉𝒽𝒶𝓉  𝒸𝒶𝓃 𝒸❤</p>
                </div>
                </div>
              </div>
              ...
              <div class="d-block w-100">
                <div class="instagram_top d-flex justify-content-between">
                  <div class="textbox">
                     <strong class="lightred">2.1%</strong> engagement
                  </div>
                  <div class="textbox">
                     CPF-$0.09
                  </div>
                ...
                <div class="instagram_thumble">
                  <img src="images/instagramimg1.jpg" alt="">
                </div>
                <div class="instagram_bootom">
                  <div class="instagram_bootom_top clearfix">
                    <ul>
                  ...
                  <p>𝒯𝒽𝒾𝓈 𝓈𝒾𝓉𝑒 𝒶𝓁𝓁🌞𝓌𝓈 𝓎🍪𝓊 𝓉☯ 𝑔𝑒𝓃𝑒𝓇𝒶𝓉𝑒 𝓉𝑒𝓍𝓉 𝒻🌞𝓃𝓉𝓈 𝓉𝒽𝒶𝓉 𝓎🌞𝓊 𝒸𝒶𝓃 𝒸❤𝓅𝓎</p>
                </div>
                </div>
              </div>
             ...
             <div class="instagram_box">
              <div class="d-block w-100">
                ...
                <div class="instagram_thumble">
                  <img src="images/instagramimg2.jpg" alt="">
                </div>
                <div class="instagram_bootom">
                  <div class="instagram_bootom_top clearfix">
                    <ul>
                  ...
                  <p>𝑔𝑒𝓃𝑒𝓇𝒶𝓉𝑒 𝓉𝑒𝓍𝓉 𝒻🌞𝓃𝓉𝓈 𝓉𝒽𝒶𝓉 𝓎🌞𝓊 𝒸𝒶𝓃 𝒸❤𝓅𝓎 𝒶𝓃𝒹 𝓅𝒶𝓈𝓉𝑒 𝒾𝓃𝓉🏵 𝓎🍩𝓊𝓇 𝐼𝓃𝓈𝓉𝒶𝑔𝓇𝒶𝓂</p>
                </div>
                </div>
              </div>
