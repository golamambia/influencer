...
<div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <h3 style="text-align: center;" class="content-header-title mb-0">Plan Table</h3>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  method="post" action="<?php echo base_url();?>apanel/extra_plan/create_post" class="contact-input">
                      ...
                      <div class="modal-body">
                        ...
                        <fieldset class="form-group col-12">
                          <input type="text"  class="contact-name form-control numeric_input " placeholder="data id" name="pdataid" required>
                        </fieldset>
            ...
            <table id="example" class="table table-striped table-bordered base-style ">
              ...
              <tbody>
               ...
               ?>
                ...
                <a href="<?php echo base_url();?>apanel/extra_plan/delete/<?=$value->pid;?>" onclick="return confirm('Are you sure to delete?')"><span class="badge badge-danger" title="Click here for delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</span></a>
             ...
             aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <section class="contact-form">
                    <form  class="contact-input" method="post" action="<?php echo base_url();?>apanel/extra_plan/pricing_edit/<?=$value->pid;?>">
                      <div class="modal-header">
                      ...
                      <div class="modal-body">
                        ...
                        <fieldset class="form-group col-12">
                          <input type="text"  class="contact-name form-control numeric_input " placeholder="data id" name="pdataid" value="<?=$value->pdataid;?>" required>
                        </fieldset>
                      </div>
                      <div class="modal-footer">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
